"""
Autogenerated config CLI plugin for the SONiC Power over Ethernet feature.
"""
...
@click.group(name="poe-port",
             cls=clicommon.AliasedGroup)
def POE_PORT():
    """ Power over Ethernet configuration (POE_PORT table in config_db.json) """

    pass


@POE_PORT.command(name="add")
@click.argument(
    "ifname",
    nargs=1,
    required=True,
...
@click.option(
    "--enabled",
    help="PoE status on port. [enable/disable]",
)
@click.option(
    "--power-limit",
    help="Power limit on PoE port. [0..999] [mandatory]",
)
@click.option(
    "--priority",
    help="Port priority level. [crit/high/low]",
)
@clicommon.pass_db
def POE_PORT_add(db, ifname, enabled, power_limit, priority):
    """ Add object in POE_PORT. """
...
@clicommon.pass_db
def POE_PORT_update(db, ifname, enabled, power_limit, priority):
    """ Add object in POE_PORT. """
...
@clicommon.pass_db
def POE_PORT_delete(db, ifname):
    """ Delete object in POE_PORT. """
